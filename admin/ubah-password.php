      ...
      <div class="container-fluid page-body-wrapper">
         <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <ul class="nav">
               ...
               <li class="nav-item">
                  <a href="ubah-password.php" class="nav-link" style="color:aqua;">Data Admin</a>
               </li>
            </ul>
         </nav>
         <!-- partial -->
                        ...
                        <div class="card-body">
                           ...
                           <form class="forms-sample" method="POST">
                              ...
                              <div class="form-group">
                                 ...
                                 <input type="text" class="form-control" id="exampleInputName1" name="username" value="<?php echo $row['name'] ?>">
                              </div>
                              <div class="form-group">
                                 <label for="exampleInputName1">Password</label>
                                 <input type="text" class="form-control" id="exampleInputName1" name="password" value="<?php echo $row['password'] ?>">
                              </div>
                              <?php }} ?>
