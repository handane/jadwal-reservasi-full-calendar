...
<body>
   ...
   <div class="product-section mt-150 mb-150">
      <div class="container">
         <h4 style="color: skyblue;">Profile</h4>
         <div class="row product-lists">
            <div class="col-lg-6 col-md-6">
               <div class="single-product-item">
                  <div class="product-image text-center">
                     <img src="imagefrom/profile.gif" alt="">
                  </div>
               </div>
            </div>
            <div class="col-lg-6 col-md-6">
               <div class="single-product-item">
                  <div class="pt-5">
                     ...
                     <div class="card m-3">
                        <div class="card-body">
                           <?php
                           $user = mysqli_query($conn, "SELECT * FROM user WHERE id = '" . $_SESSION['user']['id'] . "'");
                           ...
                           <table style="width: 100%;">
                              ...
                              <tr style="text-align: center;">
                                 <td colspan="3"><a href="logout.php" class="btn btn-danger mt-4">Logout</a></td>
                              </tr>
                           </table>
                        </div>
                     </div>
